...
|---|---------|-------|--------|---------|--------|
| 019 | Enhance Spec-Driven Agent | javascript-implementer | Approved | 2026-04-25 | [spec/019-enhance-spec-driven-agent](https://github.com/calavia-org/opencode-hub/tree/spec/019-enhance-spec-driven-agent) |
