...
- `concepts/business-domain.md` - Why this technical foundation exists
- `guides/business-tech-bridge.md` - How business needs map to technical solutions
- `guides/decisions-log.md` - Full decision history with context
