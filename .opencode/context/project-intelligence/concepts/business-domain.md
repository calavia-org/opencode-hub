...
- `concepts/technical-domain.md` - How this business need is solved technically
- `guides/business-tech-bridge.md` - Mapping between business and technical
- `guides/decisions-log.md` - Business decisions with context
