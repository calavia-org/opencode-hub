...
- `guides/decisions-log.md` - Past decisions that inform current state
- `concepts/business-domain.md` - Business context for current priorities
- `concepts/technical-domain.md` - Technical context for current state
- `guides/business-tech-bridge.md` - Context for current trade-offs
