...
- `concepts/technical-domain.md` - Technical implementation affected by these decisions
- `guides/business-tech-bridge.md` - How decisions connect business and technical
- `lookup/living-notes.md` - Current open questions that may become decisions
