...
- `concepts/technical-domain.md` - Technical implementation in detail
- `guides/decisions-log.md` - Decisions made with full context
- `lookup/living-notes.md` - Current open questions and issues
