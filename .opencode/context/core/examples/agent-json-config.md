...
**Purpose**: Full agents array from https://opencode.calavia.org/agents
...
```json
{
  "agents": [
    ...
    {"name": "opencode-implementer", "description": "Implements OpenCode/Spec-driven code"},
    ...
    {"name": "terraform-implementer", "description": "Writes Terraform code"},
    {"name": "terraform-tester", "description": "Tests and security scans"},
    {"name": "terraform-verifier", "description": "TFLint, checkov, OPA"},
...
**Related**: concepts/agent-architecture.md, lookup/agent-reference.md
